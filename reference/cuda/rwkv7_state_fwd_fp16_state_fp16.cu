...
__global__ void kernel_forward(const int B, const int T, const int C, const int H,
                               F *__restrict__ _state, const F *__restrict__ const _r, const F *__restrict__ const _w,
                               ...
                               F *__restrict__ const _y)
{
    ...
    // state is [B, H, N, N] contiguous => offset = ((bbb*H + h)*N + i)*N
